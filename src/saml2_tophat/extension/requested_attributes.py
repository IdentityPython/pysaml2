...
def requested_attribute_type__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(RequestedAttributeType_, xml_string)
...
def requested_attributes_type__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(RequestedAttributesType_, xml_string)
...
def requested_attributes_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(RequestedAttributes, xml_string)

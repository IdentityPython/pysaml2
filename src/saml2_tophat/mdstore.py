...
from saml2_tophat.extension.idpdisc import DiscoveryResponse
from saml2_tophat.md import EntitiesDescriptor
from saml2_tophat.mdie import to_dict
from saml2_tophat.s_utils import UnsupportedBinding
from saml2_tophat.s_utils import UnknownSystemEntity
from saml2_tophat.sigver import split_len
from saml2_tophat.validate import valid_instance
from saml2_tophat.time_util import valid
...
def load_extensions():
    from saml2_tophat import extension
    import pkgutil

...
from saml2_tophat.ws import wsaddr as wsa
from saml2_tophat.ws import wssec as wsse
from saml2_tophat.ws import wsutil as wsu
from saml2_tophat.ws import wspol as wsp
...
def request_security_token_type__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(RequestSecurityTokenType_, xml_string)
...
def token_type_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(TokenType, xml_string)
...
def request_type_open_enum__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(RequestTypeOpenEnum_, xml_string)
...
def request_type_enum__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(RequestTypeEnum_, xml_string)
...
def request_security_token_response_type__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(RequestSecurityTokenResponseType_, xml_string)
...
def requested_security_token_type__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(RequestedSecurityTokenType_, xml_string)
...
def binary_secret_type_enum__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(BinarySecretTypeEnum_, xml_string)
...
def binary_secret_type_open_enum__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(BinarySecretTypeOpenEnum_, xml_string)
...
def claims_type__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(ClaimsType_, xml_string)
...
def entropy_type__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(EntropyType_, xml_string)
...
def lifetime_type__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(LifetimeType_, xml_string)
...
def request_security_token_collection_type__request_security_token_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(RequestSecurityTokenCollectionType_RequestSecurityToken, xml_string)
...
def request_security_token_collection_type__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(RequestSecurityTokenCollectionType_, xml_string)
...
def computed_key_enum__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(ComputedKeyEnum_, xml_string)
...
def computed_key_open_enum__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(ComputedKeyOpenEnum_, xml_string)
...
def requested_reference_type__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(RequestedReferenceType_, xml_string)
...
def requested_proof_token_type__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(RequestedProofTokenType_, xml_string)
...
def renew_target_type__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(RenewTargetType_, xml_string)
...
def allow_postdating_type__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(AllowPostdatingType_, xml_string)
...
def renewing_type__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(RenewingType_, xml_string)
...
def cancel_target_type__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(CancelTargetType_, xml_string)
...
def requested_token_cancelled_type__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(RequestedTokenCancelledType_, xml_string)
...
def validate_target_type__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(ValidateTargetType_, xml_string)
...
def status_code_enum__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(StatusCodeEnum_, xml_string)
...
def status_code_open_enum__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(StatusCodeOpenEnum_, xml_string)
...
def challenge_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(Challenge, xml_string)
...
def binary_exchange_type__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(BinaryExchangeType_, xml_string)
...
def request_ket_type__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(RequestKETType_, xml_string)
...
def key_exchange_token_type__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(KeyExchangeTokenType_, xml_string)
...
def combined_hash_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(CombinedHash, xml_string)
...
def on_behalf_of_type__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(OnBehalfOfType_, xml_string)
...
def issuer_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(Issuer, xml_string)
...
def authentication_type_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(AuthenticationType, xml_string)
...
def key_type_enum__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(KeyTypeEnum_, xml_string)
...
def key_type_open_enum__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(KeyTypeOpenEnum_, xml_string)
...
def signature_algorithm_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(SignatureAlgorithm, xml_string)
...
def encryption_algorithm_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(EncryptionAlgorithm, xml_string)
...
def canonicalization_algorithm_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(CanonicalizationAlgorithm, xml_string)
...
def computed_key_algorithm_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(ComputedKeyAlgorithm, xml_string)
...
def encryption_type__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(EncryptionType_, xml_string)
...
def proof_encryption_type__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(ProofEncryptionType_, xml_string)
...
def use_key_type__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(UseKeyType_, xml_string)
...
def key_wrap_algorithm_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(KeyWrapAlgorithm, xml_string)
...
def sign_with_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(SignWith, xml_string)
...
def encrypt_with_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(EncryptWith, xml_string)
...
def delegate_to_type__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(DelegateToType_, xml_string)
...
def forwardable_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(Forwardable, xml_string)
...
def delegatable_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(Delegatable, xml_string)
...
def participant_type__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(ParticipantType_, xml_string)
...
def request_security_token_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(RequestSecurityToken, xml_string)
...
def request_type_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(RequestType, xml_string)
...
def request_security_token_response_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(RequestSecurityTokenResponse, xml_string)
...
def requested_security_token_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(RequestedSecurityToken, xml_string)
...
def binary_secret_type__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(BinarySecretType_, xml_string)
...
def claims_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(Claims, xml_string)
...
def entropy_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(Entropy, xml_string)
...
def lifetime_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(Lifetime, xml_string)
...
def request_security_token_collection_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(RequestSecurityTokenCollection, xml_string)
...
def request_security_token_response_collection_type__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(RequestSecurityTokenResponseCollectionType_, xml_string)
...
def computed_key_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(ComputedKey, xml_string)
...
def requested_attached_reference_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(RequestedAttachedReference, xml_string)
...
def requested_unattached_reference_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(RequestedUnattachedReference, xml_string)
...
def requested_proof_token_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(RequestedProofToken, xml_string)
...
def issued_tokens_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(IssuedTokens, xml_string)
...
def renew_target_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(RenewTarget, xml_string)
...
def allow_postdating_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(AllowPostdating, xml_string)
...
def renewing_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(Renewing, xml_string)
...
def cancel_target_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(CancelTarget, xml_string)
...
def requested_token_cancelled_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(RequestedTokenCancelled, xml_string)
...
def validate_target_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(ValidateTarget, xml_string)
...
def status_type__code_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(StatusType_Code, xml_string)
...
def status_type__reason_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(StatusType_Reason, xml_string)
...
def status_type__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(StatusType_, xml_string)
...
def sign_challenge_type__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(SignChallengeType_, xml_string)
...
def binary_exchange_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(BinaryExchange, xml_string)
...
def request_ket_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(RequestKET, xml_string)
...
def key_exchange_token_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(KeyExchangeToken, xml_string)
...
def authenticator_type__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(AuthenticatorType_, xml_string)
...
def on_behalf_of_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(OnBehalfOf, xml_string)
...
def key_type_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(KeyType, xml_string)
...
def encryption_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(Encryption, xml_string)
...
def proof_encryption_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(ProofEncryption, xml_string)
...
def use_key_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(UseKey, xml_string)
...
def delegate_to_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(DelegateTo, xml_string)
...
def participants_type__primary_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(ParticipantsType_Primary, xml_string)
...
def participants_type__participant_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(ParticipantsType_Participant, xml_string)
...
def participants_type__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(ParticipantsType_, xml_string)
...
def binary_secret_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(BinarySecret, xml_string)
...
def request_security_token_response_collection_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(RequestSecurityTokenResponseCollection, xml_string)
...
def status_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(Status, xml_string)
...
def sign_challenge_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(SignChallenge, xml_string)
...
def sign_challenge_response_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(SignChallengeResponse, xml_string)
...
def authenticator_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(Authenticator, xml_string)
...
def participants_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(Participants, xml_string)

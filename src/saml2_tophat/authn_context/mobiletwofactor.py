...
def physical_verification_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(PhysicalVerification, xml_string)
...
def generation_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(Generation, xml_string)
...
def nym_type__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(NymType_, xml_string)
...
def governing_agreement_ref_type__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(GoverningAgreementRefType_,
                                                     xml_string)
...
def key_sharing_type__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(KeySharingType_, xml_string)
...
def restricted_length_type__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(RestrictedLengthType_, xml_string)
...
def alphabet_type__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(AlphabetType_, xml_string)
...
def device_type_type__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(DeviceTypeType_, xml_string)
...
def boolean_type__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(BooleanType_, xml_string)
...
def time_sync_token_type__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(TimeSyncTokenType_, xml_string)
...
def activation_limit_duration_type__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(ActivationLimitDurationType_,
                                                     xml_string)
...
def activation_limit_usages_type__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(ActivationLimitUsagesType_,
                                                     xml_string)
...
def activation_limit_session_type__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(ActivationLimitSessionType_,
                                                     xml_string)
...
def length_type__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(LengthType_, xml_string)
...
def medium_type__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(MediumType_, xml_string)
...
def extension_type__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(ExtensionType_, xml_string)
...
def key_storage_type__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(KeyStorageType_, xml_string)
...
def key_sharing_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(KeySharing, xml_string)
...
def key_storage_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(KeyStorage, xml_string)
...
def time_sync_token_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(TimeSyncToken, xml_string)
...
def length_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(Length, xml_string)
...
def governing_agreement_ref_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(GoverningAgreementRef, xml_string)
...
def governing_agreements_type__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(GoverningAgreementsType_,
                                                     xml_string)
...
def restricted_password_type__length_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(RestrictedPasswordType_Length,
                                                     xml_string)
...
def alphabet_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(Alphabet, xml_string)
...
def activation_limit_duration_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(ActivationLimitDuration,
                                                     xml_string)
...
def activation_limit_usages_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(ActivationLimitUsages, xml_string)
...
def activation_limit_session_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(ActivationLimitSession,
                                                     xml_string)
...
def extension_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(Extension, xml_string)
...
def public_key_type__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(PublicKeyType_, xml_string)
...
def governing_agreements_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(GoverningAgreements, xml_string)
...
def password_type__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(PasswordType_, xml_string)
...
def restricted_password_type__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(RestrictedPasswordType_,
                                                     xml_string)
...
def token_type__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(TokenType_, xml_string)
...
def activation_limit_type__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(ActivationLimitType_, xml_string)
...
def extension_only_type__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(ExtensionOnlyType_, xml_string)
...
def written_consent_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(WrittenConsent, xml_string)
...
def subscriber_line_number_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(SubscriberLineNumber, xml_string)
...
def user_suffix_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(UserSuffix, xml_string)
...
def password_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(Password, xml_string)
...
def token_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(Token, xml_string)
...
def smartcard_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(Smartcard, xml_string)
...
def activation_limit_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(ActivationLimit, xml_string)
...
def previous_session_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(PreviousSession, xml_string)
...
def resume_session_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(ResumeSession, xml_string)
...
def zero_knowledge_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(ZeroKnowledge, xml_string)
...
def shared_secret_challenge_response_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(SharedSecretChallengeResponse,
                                                     xml_string)
...
def dig_sig_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(DigSig, xml_string)
...
def asymmetric_decryption_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(AsymmetricDecryption, xml_string)
...
def asymmetric_key_agreement_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(AsymmetricKeyAgreement,
                                                     xml_string)
...
def ip_address_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(IPAddress, xml_string)
...
def shared_secret_dynamic_plaintext_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(SharedSecretDynamicPlaintext,
                                                     xml_string)
...
def http_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(HTTP, xml_string)
...
def ip_sec_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(IPSec, xml_string)
...
def wtls_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(WTLS, xml_string)
...
def mobile_network_no_encryption_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(MobileNetworkNoEncryption,
                                                     xml_string)
...
def mobile_network_radio_encryption_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(MobileNetworkRadioEncryption,
                                                     xml_string)
...
def mobile_network_end_to_end_encryption_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(MobileNetworkEndToEndEncryption,
                                                     xml_string)
...
def ssl_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(SSL, xml_string)
...
def pstn_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(PSTN, xml_string)
...
def isdn_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(ISDN, xml_string)
...
def adsl_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(ADSL, xml_string)
...
def switch_audit_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(SwitchAudit, xml_string)
...
def deactivation_call_center_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(DeactivationCallCenter,
                                                     xml_string)
...
def restricted_password_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(RestrictedPassword, xml_string)
...
def activation_pin_type__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(ActivationPinType_, xml_string)
...
def complex_authenticator_type__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(ComplexAuthenticatorType_,
                                                     xml_string)
...
def security_audit_type__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(SecurityAuditType_, xml_string)
...
def identification_type__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(IdentificationType_, xml_string)
...
def identification_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(Identification, xml_string)
...
def activation_pin_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(ActivationPin, xml_string)
...
def complex_authenticator_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(ComplexAuthenticator, xml_string)
...
def authenticator_transport_protocol_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(AuthenticatorTransportProtocol,
                                                     xml_string)
...
def security_audit_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(SecurityAudit, xml_string)
...
def key_activation_type__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(KeyActivationType_, xml_string)
...
def authenticator_base_type__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(AuthenticatorBaseType_,
                                                     xml_string)
...
def operational_protection_type__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(OperationalProtectionType_,
                                                     xml_string)
...
def key_activation_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(KeyActivation, xml_string)
...
def principal_authentication_mechanism_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(PrincipalAuthenticationMechanism,
                                                     xml_string)
...
def operational_protection_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(OperationalProtection, xml_string)
...
def authn_method_base_type__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(AuthnMethodBaseType_, xml_string)
...
def private_key_protection_type__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(PrivateKeyProtectionType_,
                                                     xml_string)
...
def secret_key_protection_type__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(SecretKeyProtectionType_,
                                                     xml_string)
...
def secret_key_protection_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(SecretKeyProtection, xml_string)
...
def private_key_protection_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(PrivateKeyProtection, xml_string)
...
def authn_method_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(AuthnMethod, xml_string)
...
def technical_protection_base_type__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(TechnicalProtectionBaseType_,
                                                     xml_string)
...
def technical_protection_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(TechnicalProtection, xml_string)
...
def authn_context_declaration_base_type__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(AuthnContextDeclarationBaseType_,
                                                     xml_string)
...
def authentication_context_declaration_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(AuthenticationContextDeclaration,
                                                     xml_string)

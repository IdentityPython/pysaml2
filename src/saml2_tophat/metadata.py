#!/usr/bin/env python
from saml2_tophat.algsupport import algorithm_support_in_metadata
from saml2_tophat.md import AttributeProfile
...
from saml2_tophat.attribute_converter import from_local_name
from saml2_tophat import md, SAMLError
...
from saml2_tophat.s_utils import rec_factory
...
NSPAIR = {
    ...
    "saml2_tophat": "urn:oasis:names:tc:SAML:2.0:assertion",
...
def do_extensions(mname, item):
    try:
        _mod = __import__("saml2_tophat.extension.%s" % mname, globals(), locals(),
                          mname)
    except ImportError:
        return None
    else:

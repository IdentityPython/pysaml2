...
def status_message_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(StatusMessage, xml_string)
...
def status_detail_type__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(StatusDetailType_, xml_string)
...
def authn_context_comparison_type__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(AuthnContextComparisonType_,
                                                     xml_string)
...
def name_id_policy_type__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(NameIDPolicyType_, xml_string)
...
def requester_id_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(RequesterID, xml_string)
...
def idp_entry_type__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(IDPEntryType_, xml_string)
...
def get_complete_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(GetComplete, xml_string)
...
def artifact_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(Artifact, xml_string)
...
def new_id_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(NewID, xml_string)
...
def new_encrypted_id_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(NewEncryptedID, xml_string)
...
def terminate_type__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(TerminateType_, xml_string)
...
def session_index_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(SessionIndex, xml_string)
...
def status_detail_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(StatusDetail, xml_string)
...
def assertion_id_request_type__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(AssertionIDRequestType_,
                                                     xml_string)
...
def requested_authn_context_type__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(RequestedAuthnContextType_,
                                                     xml_string)
...
def attribute_query_type__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(AttributeQueryType_, xml_string)
...
def authz_decision_query_type__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(AuthzDecisionQueryType_,
                                                     xml_string)
...
def name_id_policy_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(NameIDPolicy, xml_string)
...
def idp_entry_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(IDPEntry, xml_string)
...
def artifact_resolve_type__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(ArtifactResolveType_, xml_string)
...
def terminate_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(Terminate, xml_string)
...
def logout_request_type__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(LogoutRequestType_, xml_string)
...
def name_id_mapping_request_type__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(NameIDMappingRequestType_,
                                                     xml_string)
...
def assertion_id_request_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(AssertionIDRequest, xml_string)
...
def subject_query_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(SubjectQuery, xml_string)
...
def requested_authn_context_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(RequestedAuthnContext, xml_string)
...
def attribute_query_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(AttributeQuery, xml_string)
...
def authz_decision_query_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(AuthzDecisionQuery, xml_string)
...
def idp_list_type__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(IDPListType_, xml_string)
...
def artifact_resolve_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(ArtifactResolve, xml_string)
...
def manage_name_id_request_type__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(ManageNameIDRequestType_,
                                                     xml_string)
...
def logout_request_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(LogoutRequest, xml_string)
...
def name_id_mapping_request_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(NameIDMappingRequest, xml_string)
...
def authn_query_type__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(AuthnQueryType_, xml_string)
...
def idp_list_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(IDPList, xml_string)
...
def manage_name_id_request_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(ManageNameIDRequest, xml_string)
...
def authn_query_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(AuthnQuery, xml_string)
...
def scoping_type__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(ScopingType_, xml_string)
...
def scoping_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(Scoping, xml_string)
...
def authn_request_type__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(AuthnRequestType_, xml_string)
...
def authn_request_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(AuthnRequest, xml_string)
...
def status_response_type__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(StatusResponseType_, xml_string)
...
def response_type__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(ResponseType_, xml_string)
...
def artifact_response_type__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(ArtifactResponseType_, xml_string)
...
def manage_name_id_response_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(ManageNameIDResponse, xml_string)
...
def logout_response_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(LogoutResponse, xml_string)
...
def name_id_mapping_response_type__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(NameIDMappingResponseType_,
                                                     xml_string)
...
def response_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(Response, xml_string)
...
def artifact_response_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(ArtifactResponse, xml_string)
...
def name_id_mapping_response_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(NameIDMappingResponse, xml_string)
...
def status_code_type__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(StatusCodeType_, xml_string)
...
def status_code_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(StatusCode, xml_string)

...
def crypto_binary__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(CryptoBinary_, xml_string)
...
def signature_value_type__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(SignatureValueType_, xml_string)
...
def canonicalization_method_type__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(CanonicalizationMethodType_,
                                                     xml_string)
...
def transform_type__x_path_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(TransformType_XPath, xml_string)
...
def transform_type__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(TransformType_, xml_string)
...
def digest_method_type__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(DigestMethodType_, xml_string)
...
def digest_value_type__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(DigestValueType_, xml_string)
...
def key_name_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(KeyName, xml_string)
...
def mgmt_data_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(MgmtData, xml_string)
...
def x509_issuer_name_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(X509IssuerName, xml_string)
...
def x509_serial_number_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(X509SerialNumber, xml_string)
...
def x509_issuer_serial_type__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(X509IssuerSerialType_, xml_string)
...
def pgp_key_id_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(PGPKeyID, xml_string)
...
def pgp_key_packet_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(PGPKeyPacket, xml_string)
...
def pgp_data_type__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(PGPDataType_, xml_string)
...
def spki_sexp_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(SPKISexp, xml_string)
...
def spki_data_type__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(SPKIDataType_, xml_string)
...
def object_type__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(ObjectType_, xml_string)
...
def signature_property_type__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(SignaturePropertyType_,
                                                     xml_string)
...
def hmac_output_length_type__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(HMACOutputLengthType_, xml_string)
...
def p_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(P, xml_string)
...
def q_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(Q, xml_string)
...
def g_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(G, xml_string)
...
def y_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(Y, xml_string)
...
def j_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(J, xml_string)
...
def seed_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(Seed, xml_string)
...
def pgen_counter_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(PgenCounter, xml_string)
...
def dsa_key_value_type__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(DSAKeyValueType_, xml_string)
...
def modulus_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(Modulus, xml_string)
...
def exponent_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(Exponent, xml_string)
...
def rsa_key_value_type__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(RSAKeyValueType_, xml_string)
...
def signature_value_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(SignatureValue, xml_string)
...
def canonicalization_method_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(CanonicalizationMethod,
                                                     xml_string)
...
def hmac_output_length_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(HMACOutputLength, xml_string)
...
def signature_method_type__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(SignatureMethodType_, xml_string)
...
def transform_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(Transform, xml_string)
...
def digest_method_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(DigestMethod, xml_string)
...
def digest_value_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(DigestValue, xml_string)
...
def x509_issuer_serial_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(X509IssuerSerial, xml_string)
...
def x509_ski_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(X509SKI, xml_string)
...
def x509_subject_name_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(X509SubjectName, xml_string)
...
def x509_certificate_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(X509Certificate, xml_string)
...
def x509_crl_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(X509CRL, xml_string)
...
def x509_data_type__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(X509DataType_, xml_string)
...
def pgp_data_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(PGPData, xml_string)
...
def spki_data_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(SPKIData, xml_string)
...
def object_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(Object, xml_string)
...
def signature_property_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(SignatureProperty, xml_string)
...
def dsa_key_value_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(DSAKeyValue, xml_string)
...
def rsa_key_value_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(RSAKeyValue, xml_string)
...
def signature_method_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(SignatureMethod, xml_string)
...
def transforms_type__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(TransformsType_, xml_string)
...
def key_value_type__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(KeyValueType_, xml_string)
...
def x509_data_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(X509Data, xml_string)
...
def signature_properties_type__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(SignaturePropertiesType_,
                                                     xml_string)
...
def key_value_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(KeyValue, xml_string)
...
def retrieval_method_type__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(RetrievalMethodType_, xml_string)
...
def signature_properties_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(SignatureProperties, xml_string)
...
def reference_type__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(ReferenceType_, xml_string)
...
def retrieval_method_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(RetrievalMethod, xml_string)
...
def key_info_type__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(KeyInfoType_, xml_string)
...
def manifest_type__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(ManifestType_, xml_string)
...
def signed_info_type__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(SignedInfoType_, xml_string)
...
def key_info_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(KeyInfo, xml_string)
...
def manifest_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(Manifest, xml_string)
...
def signed_info_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(SignedInfo, xml_string)
...
def signature_type__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(SignatureType_, xml_string)
...
def signature_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(Signature, xml_string)

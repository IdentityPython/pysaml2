...
import saml2_tophat.cryptography.asymmetric
import saml2_tophat.cryptography.pki
...
from saml2_tophat import ExtensionElement
...
from saml2_tophat.s_utils import Unsupported

from saml2_tophat.time_util import instant
from saml2_tophat.time_util import utc_now
from saml2_tophat.time_util import str_to_time

from saml2_tophat.xmldsig import SIG_RSA_SHA1
from saml2_tophat.xmldsig import SIG_RSA_SHA224
from saml2_tophat.xmldsig import SIG_RSA_SHA256
from saml2_tophat.xmldsig import SIG_RSA_SHA384
from saml2_tophat.xmldsig import SIG_RSA_SHA512
from saml2_tophat.xmlenc import EncryptionMethod
from saml2_tophat.xmlenc import EncryptedKey
from saml2_tophat.xmlenc import CipherData
from saml2_tophat.xmlenc import CipherValue
from saml2_tophat.xmlenc import EncryptedData
...
def extract_rsa_key_from_x509_cert(pem):
    cert = saml2_tophat.cryptography.pki.load_pem_x509_certificate(pem)
...
def import_rsa_key_from_file(filename):
    ...
    key = saml2_tophat.cryptography.asymmetric.load_pem_private_key(data, None)
    return key
...
class RSASigner(Signer):
    ...
    def sign(self, msg, key=None):
        return saml2_tophat.cryptography.asymmetric.key_sign(
                key or self.key, msg, self.digest)

    def verify(self, msg, sig, key=None):
        return saml2_tophat.cryptography.asymmetric.key_verify(
                key or self.key, sig, msg, self.digest)


SIGNER_ALGS = {
    SIG_RSA_SHA1: RSASigner(saml2_tophat.cryptography.asymmetric.hashes.SHA1()),
    SIG_RSA_SHA224: RSASigner(saml2_tophat.cryptography.asymmetric.hashes.SHA224()),
    SIG_RSA_SHA256: RSASigner(saml2_tophat.cryptography.asymmetric.hashes.SHA256()),
    SIG_RSA_SHA384: RSASigner(saml2_tophat.cryptography.asymmetric.hashes.SHA384()),
    SIG_RSA_SHA512: RSASigner(saml2_tophat.cryptography.asymmetric.hashes.SHA512()),
}

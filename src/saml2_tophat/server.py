...
import saml2_tophat.cryptography.symmetric
...
from saml2_tophat.argtree import add_path, is_set

from saml2_tophat.entity import Entity
from saml2_tophat.eptid import Eptid
from saml2_tophat.eptid import EptidShelve
from saml2_tophat.samlp import NameIDMappingResponse
from saml2_tophat.sdb import SessionStorage
from saml2_tophat.schema import soapenv

from saml2_tophat.request import AuthnRequest
from saml2_tophat.request import AssertionIDRequest
from saml2_tophat.request import AttributeQuery
from saml2_tophat.request import NameIDMappingRequest
from saml2_tophat.request import AuthzDecisionQuery
from saml2_tophat.request import AuthnQuery

from saml2_tophat.s_utils import MissingValue
from saml2_tophat.s_utils import rndstr
from saml2_tophat.s_utils import Unknown

from saml2_tophat.sigver import pre_signature_part
from saml2_tophat.sigver import signed_instance_factory
from saml2_tophat.sigver import CertificateError

from saml2_tophat.assertion import Assertion
from saml2_tophat.assertion import Policy
from saml2_tophat.assertion import restriction_from_attribute_spec
from saml2_tophat.assertion import filter_attribute_value_assertions

from saml2_tophat.ident import IdentDB, decode
...
class Server(Entity):
    ...
    def __init__(self, config_file="", config=None, cache=None, stype="idp",
        ...
        if symkey:
            ...
            self.symkey = saml2_tophat.cryptography.symmetric.Default.generate_key()
        self.seed = rndstr()
    ...
    def choose_session_storage(self):
        ...
        if not _spec:
            ...
            if typ.lower() == "mongodb":
                from saml2_tophat.mongo_store import SessionStorageMDB
    ...
    def init_config(self, stype="idp"):
        ...
        if not dbspec:
            ...
            if typ == "shelve":
                ...
                from saml2_tophat.mongo_store import IdentMDB

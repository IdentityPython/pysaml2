...
import time
import py
from saml2.mcache import Cache
...
class TestClass:
    ...
    def teardown_class(self):
        try:
            for subject_id in self.cache.subjects():
                self.cache.delete(subject_id)
        except TypeError:
            print "You have to have a memcached server running locally listening on port 11211 for this to work"
            assert False

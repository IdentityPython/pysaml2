...
"""
from saml2_tophat.request import LogoutRequest
import saml2_tophat

from saml2_tophat import saml, SAMLError
...
from saml2_tophat.ident import decode, code
from saml2_tophat.httpbase import HTTPError
from saml2_tophat.s_utils import sid
from saml2_tophat.s_utils import status_message_factory
...
from saml2_tophat.time_util import not_on_or_after
from saml2_tophat.saml import AssertionIDRef
from saml2_tophat.client_base import Base
from saml2_tophat.client_base import SignOnError
from saml2_tophat.client_base import LogoutError
from saml2_tophat.client_base import NoServiceDefined
...
class Saml2Client(Base):
    ...
    def prepare_for_authenticate(
            ...
            binding=saml2_tophat.BINDING_HTTP_REDIRECT, vorg="", nameid_format=None,
            scoping=None, consent=None, extensions=None, sign=None,
            response_binding=saml2_tophat.BINDING_HTTP_POST, **kwargs):

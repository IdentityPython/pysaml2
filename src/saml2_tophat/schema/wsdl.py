...
def t_documentation__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(TDocumentation_, xml_string)
...
def t_documented_documentation_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(TDocumented_documentation, xml_string)
...
def t_documented__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(TDocumented_, xml_string)
...
def t_import__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(TImport_, xml_string)
...
def t_types__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(TTypes_, xml_string)
...
def t_part__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(TPart_, xml_string)
...
def t_operation__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(TOperation_, xml_string)
...
def t_param__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(TParam_, xml_string)
...
def t_fault__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(TFault_, xml_string)
...
def t_binding_operation_message__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(TBindingOperationMessage_, xml_string)
...
def t_binding_operation_fault__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(TBindingOperationFault_, xml_string)
...
def t_binding_operation_input_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(TBindingOperation_input, xml_string)
...
def t_binding_operation_output_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(TBindingOperation_output, xml_string)
...
def t_binding_operation_fault_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(TBindingOperation_fault, xml_string)
...
def t_binding_operation__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(TBindingOperation_, xml_string)
...
def t_port__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(TPort_, xml_string)
...
def import_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(Import, xml_string)
...
def types_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(Types, xml_string)
...
def t_message_part_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(TMessage_part, xml_string)
...
def t_message__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(TMessage_, xml_string)
...
def t_port_type_operation_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(TPortType_operation, xml_string)
...
def t_port_type__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(TPortType_, xml_string)
...
def t_binding_operation_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(TBinding_operation, xml_string)
...
def t_binding__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(TBinding_, xml_string)
...
def t_service_port_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(TService_port, xml_string)
...
def t_service__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(TService_, xml_string)
...
def message_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(Message, xml_string)
...
def port_type_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(PortType, xml_string)
...
def binding_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(Binding, xml_string)
...
def service_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(Service, xml_string)
...
def t_definitions__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(TDefinitions_, xml_string)
...
def definitions_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(Definitions, xml_string)

...
def signing_method_type__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(SigningMethodType_, xml_string)
...
def signing_method_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(SigningMethod, xml_string)

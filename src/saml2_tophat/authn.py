...
from saml2_tophat.httputil import make_cookie
from saml2_tophat.httputil import Redirect
from saml2_tophat.httputil import Unauthorized
from saml2_tophat.httputil import parse_cookie
...
class UsernamePasswordMako(UserAuthnMethod):
    ...
    def __init__(self, srv, mako_template, template_lookup, pwd, return_to):
        ...
        self.symmetric = saml2_tophat.cryptography.symmetric.Default(srv.symkey)

...
from saml2_tophat.xmldsig import KeyInfo
...
def spcertenc_type__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(SPCertEncType_, xml_string)
...
def spcertenc_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(SPCertEnc, xml_string)

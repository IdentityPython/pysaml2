...
def t_timestamp_fault__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(TTimestampFault_, xml_string)
...
def attributed_date_time__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(AttributedDateTime_, xml_string)
...
def attributed_ur_i__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(AttributedURI_, xml_string)
...
def expires_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(Expires, xml_string)
...
def created_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(Created, xml_string)
...
def timestamp_type__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(TimestampType_, xml_string)
...
def timestamp_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(Timestamp, xml_string)

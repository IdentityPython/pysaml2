...
def reference_parameters_type__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(ReferenceParametersType_, xml_string)
...
def relationship_type_open_enum__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(RelationshipTypeOpenEnum_, xml_string)
...
def fault_codes_type__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(FaultCodesType_, xml_string)
...
def attributed_unsigned_long_type__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(AttributedUnsignedLongType_, xml_string)
...
def attributed_q_name_type__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(AttributedQNameType_, xml_string)
...
def problem_iri_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(ProblemIRI, xml_string)
...
def endpoint_reference_type__address_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(EndpointReferenceType_Address, xml_string)
...
def reference_parameters_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(ReferenceParameters, xml_string)
...
def metadata_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(Metadata, xml_string)
...
def message_id_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(MessageID, xml_string)
...
def relates_to_type__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(RelatesToType_, xml_string)
...
def problem_header_q_name_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(ProblemHeaderQName, xml_string)
...
def problem_action_type__soap_action_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(ProblemActionType_SoapAction, xml_string)
...
def problem_action_type__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(ProblemActionType_, xml_string)
...
def endpoint_reference_type__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(EndpointReferenceType_, xml_string)
...
def endpoint_reference_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(EndpointReference, xml_string)

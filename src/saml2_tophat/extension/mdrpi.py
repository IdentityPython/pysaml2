...
def publication_info_type__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(PublicationInfoType_, xml_string)
...
def publication_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(Publication, xml_string)
...
def publication_path_type__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(PublicationPathType_, xml_string)

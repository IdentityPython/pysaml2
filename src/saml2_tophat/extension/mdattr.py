...
def entity_attributes_type__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(EntityAttributesType_, xml_string)
...
def entity_attributes_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(EntityAttributes, xml_string)

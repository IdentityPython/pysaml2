...
from saml2_tophat.schema import wsdl
...
def encoding_style__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(EncodingStyle_, xml_string)
...
def t_style_choice__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(TStyleChoice_, xml_string)
...
def use_choice__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(UseChoice_, xml_string)
...
def t_header_fault__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(THeaderFault_, xml_string)
...
def t_address__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(TAddress_, xml_string)
...
def operation_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(Operation, xml_string)
...
def t_body__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(TBody_, xml_string)
...
def fault_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(Fault, xml_string)
...
def headerfault_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(Headerfault, xml_string)
...
def address_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(Address, xml_string)
...
def body_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(Body, xml_string)
...
def t_header__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(THeader_, xml_string)
...
def header_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(Header, xml_string)

...
def username_token_type__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(UsernameTokenType_, xml_string)
...
def binary_security_token_type__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(BinarySecurityTokenType_, xml_string)
...
def key_identifier_type__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(KeyIdentifierType_, xml_string)
...
def embedded_type__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(EmbeddedType_, xml_string)
...
def security_token_reference_type__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(SecurityTokenReferenceType_, xml_string)
...
def transformation_parameters_type__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(TransformationParametersType_, xml_string)

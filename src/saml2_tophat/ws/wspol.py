...
def policy_reference_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(PolicyReference, xml_string)
...
def applies_to_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(AppliesTo, xml_string)
...
def policy_attachment_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(PolicyAttachment, xml_string)
...
def operator_content_type__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(OperatorContentType_, xml_string)
...
def policy_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(Policy, xml_string)
...
def all_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(All, xml_string)
...
def exactly_one_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(ExactlyOne, xml_string)

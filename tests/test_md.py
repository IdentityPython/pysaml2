...
class TestIndexedEndpoint:
  ...
  def testAccessors(self):
    ...
    new_i_e = md.indexed_endpoint_from_string(self.i_e.to_string())
...
class TestOrganization:
  ...
  def testAccessors(self):
    ...
    assert isinstance(new_organization.organization_url[0],
                            md.OrganizationURL)
    assert new_organization.organization_name[0].text.strip() == "SIOS Technology, Inc."
...
class TestRequestedAttribute:
  ...
  def testAccessors(self):
    ...
    assert isinstance(self.requested_attribute, saml.Attribute)
...
class TestEntityDescriptor:
  ...
  def testAccessors(self):
    ...
    self.entity_descriptor.signature = ds.get_empty_signature()
    ...
    assert isinstance(new_entity_descriptor.role_descriptor[0],
                            md.RoleDescriptor)
    assert isinstance(new_entity_descriptor.idp_sso_descriptor[0],
                            md.IDPSSODescriptor)
    assert isinstance(new_entity_descriptor.sp_sso_descriptor[0],
                            md.SPSSODescriptor)
...
class TestEntitiesDescriptor:
  ...
  def testAccessors(self):
    ...
    self.entities_descriptor.signature = ds.get_empty_signature()

...
def key_size_type__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(KeySizeType_, xml_string)
...
def cipher_value_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(CipherValue, xml_string)
...
def k_a__nonce_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(KA_Nonce, xml_string)
...
def originator_key_info_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(OriginatorKeyInfo, xml_string)
...
def recipient_key_info_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(RecipientKeyInfo, xml_string)
...
def agreement_method_type__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(AgreementMethodType_, xml_string)
...
def encryption_property_type__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(EncryptionPropertyType_, xml_string)
...
def encryption_method_type__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(EncryptionMethodType_, xml_string)
...
def cipher_reference_type__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(CipherReferenceType_, xml_string)
...
def agreement_method_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(AgreementMethod, xml_string)
...
def data_reference_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(DataReference, xml_string)
...
def key_reference_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(KeyReference, xml_string)
...
def reference_list_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(ReferenceList, xml_string)
...
def encryption_property_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(EncryptionProperty, xml_string)
...
def cipher_reference_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(CipherReference, xml_string)
...
def encryption_properties_type__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(EncryptionPropertiesType_, xml_string)
...
def cipher_data_type__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(CipherDataType_, xml_string)
...
def encryption_properties_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(EncryptionProperties, xml_string)
...
def cipher_data_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(CipherData, xml_string)
...
def encrypted_data_type__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(EncryptedDataType_, xml_string)
...
def carried_key_name_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(CarriedKeyName, xml_string)
...
def encrypted_key_type__from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(EncryptedKeyType_, xml_string)
...
def encrypted_data_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(EncryptedData, xml_string)
...
def encrypted_key_from_string(xml_string):
    return saml2_tophat.create_class_from_xml_string(EncryptedKey, xml_string)
